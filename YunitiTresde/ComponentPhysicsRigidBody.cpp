...
#include "ComponentPhysicsRigidBody.h"
...
// ---------------------------------------------------------
ComponentPhysicsRigidBody::ComponentPhysicsRigidBody(GameObject* gameObject) //: Component(gameObject, componentType)
{
	sphere.r = 1.0f;
...
// ---------------------------------------------------------
ComponentPhysicsRigidBody::~ComponentPhysicsRigidBody()
{
...
// ---------------------------------------------------------
void ComponentPhysicsRigidBody::GetBoundingBox(AABB & box) const
{
	switch (body_type)
	{
	case body_sphere:
...
// ---------------------------------------------------------
//void ComponentPhysicsRigidBody::OnSave(Config& config) const
//{
...
// ---------------------------------------------------------
//void ComponentPhysicsRigidBody::OnLoad(Config * config)
//{
...
// ---------------------------------------------------------
void ComponentPhysicsRigidBody::OnPlay()
{
	CreateBody();
}

// ---------------------------------------------------------
void ComponentPhysicsRigidBody::OnStop()
{
	//if (body != nullptr)
	//	App->physics3D->DeleteBody(body);
}
...
// ---------------------------------------------------------
void ComponentPhysicsRigidBody::OnDebugDraw(bool selected) const
{
	//if (selected == false)
	//	return;
	//
...
// ---------------------------------------------------------
void ComponentPhysicsRigidBody::getWorldTransform(btTransform & worldTrans) const
{
...
// ---------------------------------------------------------
void ComponentPhysicsRigidBody::setWorldTransform(const btTransform & worldTrans)
{
...
// ---------------------------------------------------------
void ComponentPhysicsRigidBody::CreateBody()
{
//	if (body != nullptr)
//		App->physics3D->DeleteBody(body);
//
...
// ---------------------------------------------------------
void ComponentPhysicsRigidBody::SetBodyType(BodyType new_type)
{
...
// ---------------------------------------------------------
ComponentPhysicsRigidBody::BodyType ComponentPhysicsRigidBody::GetBodyType() const
{
	return body_type;
}

// ---------------------------------------------------------
void ComponentPhysicsRigidBody::SetBehaviour(BodyBehaviour new_behaviour)
{
...
// ---------------------------------------------------------
ComponentPhysicsRigidBody::BodyBehaviour ComponentPhysicsRigidBody::GetBehaviour() const
{
	return behaviour;
}

// ---------------------------------------------------------
void ComponentPhysicsRigidBody::DrawEditor()
{
