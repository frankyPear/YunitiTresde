...
void ModuleCamera::DrawImmediateQuad()
{
	glPushMatrix();
	//draw stuff
...
void ModuleCamera::DrawArrayQuad()
{
...
void ModuleCamera::DrawElementQuad()
{
...
void ModuleCamera::DrawElementQuadTexturized(GLuint textureID)
{
	// enable and specify pointers to vertex arrays
	glEnableClientState(GL_VERTEX_ARRAY);
...
void ModuleCamera::DrawElementPlane()
{
	float size = 25.0f;
